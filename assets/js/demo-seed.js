    ...
    grupos: [
      {
        ...
        exercicios: [
          { nome: "Supino reto com barra",          series: "4", reps: "10", descanso: "90s", observacao: "Descer a barra até tocar o peito",              video: "https://www.youtube.com/results?search_query=supino+reto+barra+execucao" },
          { nome: "Supino inclinado com halteres",  series: "3", reps: "12", descanso: "60s", observacao: "Cotovelos a 45° do tronco",                     video: "https://www.youtube.com/results?search_query=supino+inclinado+halteres+execucao" },
          { nome: "Crucifixo reto",                 series: "3", reps: "15", descanso: "60s", observacao: "Manter leve flexão no cotovelo durante todo o movimento", video: "https://www.youtube.com/results?search_query=crucifixo+reto+peitoral+execucao" },
          { nome: "Crossover no cabo",              series: "3", reps: "15", descanso: "60s", observacao: "Cruzar as mãos no final para contrair o peitoral", video: "https://www.youtube.com/results?search_query=crossover+cabo+peitoral+execucao" },
          { nome: "Tríceps polia alta",             series: "4", reps: "12", descanso: "60s", observacao: "Cotovelos fixos ao lado do corpo",               video: "https://www.youtube.com/results?search_query=triceps+polia+alta+execucao" },
          { nome: "Tríceps testa com barra W",      series: "3", reps: "12", descanso: "60s", observacao: "Descer a barra até a testa, não atrás da cabeça", video: "https://www.youtube.com/results?search_query=triceps+testa+barra+w+execucao" },
          { nome: "Desenvolvimento com halteres",   series: "3", reps: "12", descanso: "60s", observacao: "Não bloquear o cotovelo no topo",                video: "https://www.youtube.com/results?search_query=desenvolvimento+halteres+ombro+execucao" },
        ],
      },
      {
        id: "treino-b",
        ...
        exercicios: [
          { nome: "Puxada frente (pegada aberta)",  series: "4", reps: "10", descanso: "90s", observacao: "Puxar até o queixo, peito projetado para frente",  video: "https://www.youtube.com/results?search_query=puxada+frente+pegada+aberta+execucao" },
          { nome: "Remada curvada com barra",        series: "4", reps: "10", descanso: "90s", observacao: "Coluna levemente inclinada, empurrar cotovelo para trás", video: "https://www.youtube.com/results?search_query=remada+curvada+barra+execucao" },
          { nome: "Serrote com halteres",            series: "3", reps: "12", descanso: "60s", observacao: "Apoiar joelho e mão no banco, amplitude total",    video: "https://www.youtube.com/results?search_query=serrote+halteres+costas+execucao" },
          { nome: "Pulldown no cabo",                series: "3", reps: "15", descanso: "60s", observacao: "Focar no squeeze da costas ao finalizar o movimento", video: "https://www.youtube.com/results?search_query=pulldown+cabo+costas+execucao" },
          { nome: "Rosca direta com barra",          series: "3", reps: "10", descanso: "60s", observacao: "Sem balançar o tronco — isolar o bíceps",          video: "https://www.youtube.com/results?search_query=rosca+direta+barra+execucao" },
          { nome: "Rosca martelo com halteres",      series: "3", reps: "12", descanso: "60s", observacao: "Contrair o braquiorradial no topo",                 video: "https://www.youtube.com/results?search_query=rosca+martelo+halteres+execucao" },
          { nome: "Rosca concentrada",               series: "3", reps: "12", descanso: "60s", observacao: "Apoiar o cotovelo na face interna da coxa",         video: "https://www.youtube.com/results?search_query=rosca+concentrada+biceps+execucao" },
        ],
      },
      {
        id: "treino-c",
        ...
        exercicios: [
          { nome: "Agachamento livre com barra",     series: "4", reps: "8",  descanso: "120s", observacao: "Descer até o paralelo. Joelhos na linha dos pés.",    video: "https://www.youtube.com/results?search_query=agachamento+livre+barra+execucao" },
          { nome: "Leg press 45°",                   series: "4", reps: "12", descanso: "90s",  observacao: "Pés na largura dos ombros. Não travar joelho no topo", video: "https://www.youtube.com/results?search_query=leg+press+45+graus+execucao" },
          { nome: "Cadeira extensora",               series: "3", reps: "15", descanso: "60s",  observacao: "Segurar 2 segundos no topo para isometria",            video: "https://www.youtube.com/results?search_query=cadeira+extensora+quadriceps+execucao" },
          { nome: "Mesa flexora",                    series: "3", reps: "12", descanso: "60s",  observacao: "Descer a fase excêntrica em 3 segundos",               video: "https://www.youtube.com/results?search_query=mesa+flexora+isquiotibiais+execucao" },
          { nome: "Stiff com halteres",              series: "3", reps: "12", descanso: "60s",  observacao: "Coluna neutra, sentir o alongamento dos posteriores",   video: "https://www.youtube.com/results?search_query=stiff+halteres+posterior+execucao" },
          { nome: "Desenvolvimento militar",         series: "4", reps: "10", descanso: "90s",  observacao: "Empurrar acima da cabeça sem arquear a lombar",         video: "https://www.youtube.com/results?search_query=desenvolvimento+militar+ombro+execucao" },
          { nome: "Elevação lateral com halteres",   series: "3", reps: "15", descanso: "60s",  observacao: "Cotovelos levemente flexionados, não usar impulso",     video: "https://www.youtube.com/results?search_query=elevacao+lateral+halteres+deltoide+execucao" },
          { nome: "Panturrilha no leg press",        series: "4", reps: "20", descanso: "45s",  observacao: "Amplitude total — calcâneo bem abaixo e ponta bem alta", video: "https://www.youtube.com/results?search_query=panturrilha+leg+press+execucao" },
        ],
      },
    ],
  };
